...
Mobile.tap(findTestObject('payment/make_payment_sidebar'), 0)

Mobile.tap(findTestObject('payment/spinner_payment'), 0)

Mobile.tap(findTestObject('payment/selector_joni2'), 0)

Mobile.tap(findTestObject('payment/btn_plus'), 0)

Mobile.setText(findTestObject('payment/add_text_payee_name'), 'Indihome', 0)
